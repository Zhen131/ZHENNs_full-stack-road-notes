...
## Imports[](http://54.173.133.152/lab/lab/tree/1-Intro-to-Prompting/99-Appendix-Hyperparams.ipynb#Imports)
...
## Top K[](http://54.173.133.152/lab/lab/tree/1-Intro-to-Prompting/99-Appendix-Hyperparams.ipynb#Top-K)
...
## Temperature[](http://54.173.133.152/lab/lab/tree/1-Intro-to-Prompting/99-Appendix-Hyperparams.ipynb#Temperature)
...
Here's a toy code example to help with your intuition. We provide again a set of words with their probabilities for coming next in the text generation.
...
The function `apply_temperature` updates the probabilities of being next relative to the temperature setting.
...
## Top P[](http://54.173.133.152/lab/lab/tree/1-Intro-to-Prompting/99-Appendix-Hyperparams.ipynb#Top-P)
...
## Combined[](http://54.173.133.152/lab/lab/tree/1-Intro-to-Prompting/99-Appendix-Hyperparams.ipynb#Combined)

The toy example below should hopefully illuminate the impact of parameters on sampled outcomes.
...
**Next step:** Open `2-Chains/20-Section-Introduction.ipynb` next: **Section 2: LCEL, Runnables, and Chains**.

**Before moving on:** Pick one hyperparameter that meaningfully changed the output, because the next section starts composing multiple prompt steps and those settings will matter inside larger workflows too.
