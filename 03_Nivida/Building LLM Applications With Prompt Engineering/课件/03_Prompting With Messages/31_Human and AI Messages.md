...
## Objectives[](http://54.173.133.152/lab/lab/tree/3-Prompting-With-Messages/31-Human-and-AI-Messages.ipynb#Objectives)
...
## Imports[](http://54.173.133.152/lab/lab/tree/3-Prompting-With-Messages/31-Human-and-AI-Messages.ipynb#Imports)
...
## Create a Model Instance[](http://54.173.133.152/lab/lab/tree/3-Prompting-With-Messages/31-Human-and-AI-Messages.ipynb#Create-a-Model-Instance)
...
## Chat Messages[](http://54.173.133.152/lab/lab/tree/3-Prompting-With-Messages/31-Human-and-AI-Messages.ipynb#Chat-Messages)
...
## Human Messages[](http://54.173.133.152/lab/lab/tree/3-Prompting-With-Messages/31-Human-and-AI-Messages.ipynb#Human-Messages)
...
## AI Messages[](http://54.173.133.152/lab/lab/tree/3-Prompting-With-Messages/31-Human-and-AI-Messages.ipynb#AI-Messages)
...
## Explicit Role Use in Prompts[](http://54.173.133.152/lab/lab/tree/3-Prompting-With-Messages/31-Human-and-AI-Messages.ipynb#Explicit-Role-Use-in-Prompts)
...
## Using ChatPromptMessages Directly[](http://54.173.133.152/lab/lab/tree/3-Prompting-With-Messages/31-Human-and-AI-Messages.ipynb#Using-ChatPromptMessages-Directly)
...
## Exercise: Create an Explicit Human Message[](http://54.173.133.152/lab/lab/tree/3-Prompting-With-Messages/31-Human-and-AI-Messages.ipynb#Exercise:-Create-an-Explicit-Human-Message)
...
### Your Work Here[](http://54.173.133.152/lab/lab/tree/3-Prompting-With-Messages/31-Human-and-AI-Messages.ipynb#Your-Work-Here)

  

### Solution[](http://54.173.133.152/lab/lab/tree/3-Prompting-With-Messages/31-Human-and-AI-Messages.ipynb#Solution)

5 cells hidden

## Explicit Use of the AI Role[](http://54.173.133.152/lab/lab/tree/3-Prompting-With-Messages/31-Human-and-AI-Messages.ipynb#Explicit-Use-of-the-AI-Role)
...
## Using `HumanMessage` and `AIMessage`[](http://54.173.133.152/lab/lab/tree/3-Prompting-With-Messages/31-Human-and-AI-Messages.ipynb#Using-HumanMessage-and-AIMessage)
...
## Summary[](http://54.173.133.152/lab/lab/tree/3-Prompting-With-Messages/31-Human-and-AI-Messages.ipynb#Summary)
...
**Next step:** Open `3-Prompting-With-Messages/32-Few-Shot-Prompting.ipynb` next: **Few-Shot Prompting**.

**Before moving on:** Keep one message format you would reuse, since the next notebook uses that same structure to turn examples into a behavior-shaping interface.
