...
| 日期 | 任务 | 状态 |
| --- | --- | --- |
| 7月17日 | Day 1：学 Web Crypto API | 未开始 |
| 7月18日 | Day 2：实现密钥派生（PBKDF2） | 未开始 |
| 7月19日 | Day 3：实现加解密 | 未开始 |
| 7月20日 | Day 4：解锁流程 + 切换真加密 | 未开始 |
| 7月21日 | Day 5：验收加密与离线 | 未开始 |
| 7月22日 | Day 6：写日志、整理下周 | 未开始 |
| 7月23日 | Day 7：休息与轻复盘 | 未开始 |
